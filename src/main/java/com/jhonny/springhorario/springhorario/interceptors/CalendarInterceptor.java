package com.jhonny.springhorario.springhorario.interceptors;
...
public class CalendarInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
            ...
            if (hour >= open && hour <= close){
                StringBuilder message =  new StringBuilder("Bienviendos al hoario de atencion a clientes");
            ...
            message.append("Porfavor visitanos desde las ");
            message.append(open);
